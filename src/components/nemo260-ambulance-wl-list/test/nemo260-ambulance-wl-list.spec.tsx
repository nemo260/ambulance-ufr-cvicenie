...
describe('nemo260-ambulance-wl-list', () => {
  ...
  it('renders sample entries', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<nemo260-ambulance-wl-list ambulance-id="test-ambulance" api-base="http://test/api"></nemo260-ambulance-wl-list>`,
    });
    const wlList = page.rootInstance as Nemo260AmbulanceWlList;
