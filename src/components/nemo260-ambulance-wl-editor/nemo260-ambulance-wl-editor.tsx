...
@Component({
  tag: 'nemo260-ambulance-wl-editor',
  styleUrl: 'nemo260-ambulance-wl-editor.css',
  shadow: true,
})
export class Nemo260AmbulanceWlEditor {
  ...
  render() {
    ...
    return (
      <Host>
        ...
        <md-filled-text-field label="Meno a Priezvisko" equired value={this.entry?.name}
